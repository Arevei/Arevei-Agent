  ...
  const sections = [
    {
      ...
      icon: FileText,
      content:
        "These Terms of Service constitute a legally binding agreement made between you, whether personally or on behalf of an entity  and Arevei , concerning your access to and use of our website and services.",
      subsections: [
